...
export const LoveLetter: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-paper flex items-center justify-center p-4 relative overflow-hidden">
        
        {/* Background Overlay */}
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-0" />
        
        {/* Paper Container */}
        <div className="relative z-10 w-full max-w-xl bg-paper-white shadow-lift rounded-sm rotate-[1deg] hover:rotate-0 transition-transform duration-500 min-h-[600px] flex flex-col">
            
            {/* Top Tape */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-32 h-8 bg-primary/80 -rotate-2 shadow-sm tape-edge" />

            <div className="p-8 md:p-12 flex flex-col h-full flex-grow relative">
                
                {/* Date */}
                <div className="self-end mb-8 font-mono text-pencil text-sm tracking-widest rotate-1">
                    FEB 14, 2024
                </div>
                ...
                <div className="mt-12 flex flex-col items-center gap-6 relative">
                    ...
                    <div className="self-end mr-8 w-48 relative text-right">
                         <div className="font-hand text-3xl text-ink transform -rotate-6">Me</div>
                    </div>

                    {/* Wax Seal Decor */}
                    <div className="absolute bottom-20 left-4 rotate-[-15deg] opacity-80">
                         <div className="w-16 h-16 rounded-full bg-accent border-4 border-dashed border-red-800/30 flex items-center justify-center shadow-sm">
                            <StarIcon />
                         </div>
                    </div>
